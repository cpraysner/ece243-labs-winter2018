...
.text                  # "text" section for code
	...
	# r23 is the pointer to the next node (i.e. address of the next node)
...
_start:
	...
	movia r23, IN_LINKED_LIST  #move the 32 bit address of the beginning of IN_LIST into r18   
...
LOOP:           
		...
		ldw r20,0(r23)
		ldw r23,4(r23)
		bgt r0,r20,NEGATIVE_NUMBER 
        ble r0,r20,POSITIVE_NUMBER
